...
/**
 * print_class_info - Prints the class of an ELF header.
...
/**
 * print_version_info - Prints the version of an ELF header.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
    ...
    check_elf_file(elf_header->e_ident);
    printf("ELF Header:\n");
    print_magic_numbers(elf_header->e_ident);
    print_class_info(elf_header->e_ident);
    print_data_encoding(elf_header->e_ident);
    print_version_info(elf_header->e_ident);
